...
Public Class frmDrukujRaportRealizacjiPlanu
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDrukujRaportRealizacjiPlanu))
        ...
        Me.picLogo.Location = New System.Drawing.Point(8, 128)
        ...
        Me.cmdDrukuj.Location = New System.Drawing.Point(297, 128)
        ...
        Me.cmdStop.Location = New System.Drawing.Point(374, 128)
        ...
        Me.Panel1.Size = New System.Drawing.Size(451, 114)
        ...
        '
        'frmDrukujRaportRealizacjiPlanu
        '
        ...
        Me.Name = "frmDrukujRaportRealizacjiPlanu"
        Me.Text = "Raport Realizacji Planu"
...
#End Region
    ...
    Private Sub frmDrukujRaportRealizacjiPlanu_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
        RysujGradient(Me)
    End Sub
    ...
    Private Function PrzygotujDane(ByVal pBiezRok As String, _
        ...
        Dim robCol3 As DataColumn = TableRoboczy.Columns.Add("POPROK", GetType(System.Double))
        Dim robCol4 As DataColumn = TableRoboczy.Columns.Add("PLAN", GetType(System.Double))
    ...
    Private Sub cmdDrukuj_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDrukuj.Click
        ...
        MyDoc.DocumentName = "Raport Realizacji Planu"
        ...
        AddHandler MyDoc.PrintPage, AddressOf MyDoc_RaportRealizacjiPlanu
        '--------------------------------------
    ...
    Private Sub MyDoc_RaportRealizacjiPlanu(ByVal sender As Object, ByVal e As PrintPageEventArgs)
        ...
        Do While True
            ...
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(5.0), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(7.0), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            ...
            CentrTxt("Specyfikacja", x, y, cm2pts(5), MyFont, e)
            CentrTxt("Pop.Rok", x + cm2pts(5), y, cm2pts(2.0), MyFont, e)
            CentrTxt("Plan", x + cm2pts(7), y, cm2pts(2.0), MyFont, e)
            CentrTxt("Realizacja", x + cm2pts(9), y, cm2pts(2.0), MyFont, e)
            CentrTxt("Realizacja narastaj¹co w poszczególnych miesi¹cach", x + cm2pts(11.0), y, cm2pts(18), MyFont, e)
            y += MyFont.GetHeight(e.Graphics)

            CentrTxt("", x, y, cm2pts(5), MyFont, e)
            CentrTxt(lblPopRok.Text, x + cm2pts(5), y, cm2pts(2.0), MyFont, e)
            CentrTxt(cbxBiezRok.Text, x + cm2pts(7), y, cm2pts(2.0), MyFont, e)
            CentrTxt(cbxBiezRok.Text, x + cm2pts(9), y, cm2pts(2.0), MyFont, e)
            ...
            If Doc.NextRowNumber < DataViewRoboczy.Count Then
                Do
                    ...
                    If rPozycja = 1 Then
                        ...
                        LeftTxt("WskaŸniki Sprzeda¿owo-Wartoœciowe analizowane na podstawie Obrotów", x, y, x + PageWidth, MyFont, e)
                        y += Int(1.5 * LineHeight)
                    ElseIf rPozycja = 11 Then
                        y += Int(1.0 * LineHeight)
                        e.Graphics.DrawLine(DrawingPen, x, y, x + cm2pts(29), y)
                        y += Int(0.5 * LineHeight)
                        LeftTxt("WskaŸniki Sprzeda¿owo-Iloœciowe analizowane na podstawie Obrotów", x, y, x + PageWidth, MyFont, e)
                        y += Int(1.5 * LineHeight)
                    ElseIf rPozycja = 21 Then
                        y += Int(1.0 * LineHeight)
                        e.Graphics.DrawLine(DrawingPen, x, y, x + cm2pts(29), y)
                        y += Int(0.5 * LineHeight)
                        LeftTxt("WskaŸniki Aktywnoœci analizowane na podstawie Kontaktów Handlowych", x, y, x + PageWidth, MyFont, e)
                        y += Int(1.5 * LineHeight)
                    End If
                    '--------------------------------------
                    ...
                    LeftTxt(rIdent, x, y, cm2pts(5 + 2), MyFont, e)
                    RightTxt(rPopRok.ToString("F0"), x + cm2pts(5), y, cm2pts(2.0), MyFont, e)
                    RightTxt(rPlan.ToString("F0"), x + cm2pts(7), y, cm2pts(2.0), MyFont, e)
