Public Class EdytujKatalogBranze
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(EdytujKatalogBranze))
        ...
        Me.Panel1.Size = New System.Drawing.Size(589, 44)
        ...
        Me.txtBranza.Location = New System.Drawing.Point(54, 9)
        Me.txtBranza.Name = "txtBranza"
        Me.txtBranza.Size = New System.Drawing.Size(512, 20)
        ...
        Me.cmdWycofajSie.Location = New System.Drawing.Point(409, 59)
        ...
        Me.cmdPrzywroc.Location = New System.Drawing.Point(312, 59)
        ...
        Me.cmdPowrot.Location = New System.Drawing.Point(519, 59)
        ...
        Me.ClientSize = New System.Drawing.Size(604, 90)
...
#End Region
    ...
    Private Sub EdytujKatalogBranze_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub EdytujKatalogBranze_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
        If oOperacja = "EDYTUJ" Then
        Else
            txtBranza.Focus()
        End If
    ...
    Private Sub EdytujKatalogBranze_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
        RysujGradient(Me)
    End Sub
    ...
    Private Sub EdytujKatalogBranze_Closing(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
    ...
    Private Sub PobierzDane()
        txtBranza.Text = brIdBranzy
    End Sub

    Private Sub ZapiszDane()
        brIdBranzy = txtBranza.Text
    End Sub
