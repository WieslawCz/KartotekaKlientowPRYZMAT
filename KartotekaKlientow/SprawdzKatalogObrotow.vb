...
Public Class SprawdzKatalogObrotow
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(SprawdzKatalogObrotow))
    ...
    ". . . . . . . . ."
        ...
        Me.Name = "SprawdzKatalogObrotow"
        Me.ShowInTaskbar = False
        Me.Text = "Sprawdzanie Katalogu Obrotów"
...
#End Region
    ...
    Dim dbSelectSQLObroty As String = "SELECT * FROM Obroty"
    ...
    Private Sub SprawdzKatalogObrotow_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
        RysujGradient(Me)
    End Sub
    ...
    Private Sub ImportKlienci_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If ParL_DataBaseType = "MS ACCESS" Then
            ...
            objParam = dbCommandDelete.Parameters.Add("@orygData", OleDb.OleDbType.VarChar, 10, "DATA")
            objParam.SourceVersion = DataRowVersion.Original
        ...
        Else
            ...
            objParam.SourceVersion = DataRowVersion.Original
            objParam = sqlCommandDelete.Parameters.Add("@orygData", SqlDbType.VarChar, 10, "DATA")
            objParam.SourceVersion = DataRowVersion.Original
        ...
        If ConnectionState = ConnectionState.Open Then
            Try
                ...
                IlePrzed = DataViewObroty.Count
                IleUsunieto = 0
                IlePo = DataViewObroty.Count
        ...
        Try
            If DataViewObroty.Count > 0 Then
                ...
                For i = IlePrzed - 1 To 0 Step -1
                    ...
                    IdKlienta = GetTxtDRVField(DataViewObroty.Item(i), "IDENTKLIENTA")
                    If Not CzyJestKlient(IdKlienta) Then
                        'usuwamy ten zapis...
                        DataViewObroty.Item(i).Delete()
                        IleUsunieto += 1
                        IlePo -= 1
            ...
            MessageBox.Show("Wykona³em sprawdzenie Katalogu Obrotów.", "Ok, skoñczy³em.", _
                System.Windows.Forms.MessageBoxButtons.OK, _
                MessageBoxIcon.Information, _
                MessageBoxDefaultButton.Button1)
            ProgressBar.Visible = False
