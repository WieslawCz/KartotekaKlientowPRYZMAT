...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Katalogi))
        ...
        Me.Panel1.Size = New System.Drawing.Size(672, 300)
        ...
        Me.ListView.Size = New System.Drawing.Size(440, 258)
        ...
        Me.lbxTabele.Location = New System.Drawing.Point(88, 32)
        Me.lbxTabele.Name = "lbxTabele"
        Me.lbxTabele.Size = New System.Drawing.Size(120, 251)
        ...
        Me.lblPlik.Size = New System.Drawing.Size(568, 16)
        ...
        Me.cmdPowrot.Location = New System.Drawing.Point(600, 316)
        ...
        Me.PictureBox2.Location = New System.Drawing.Point(16, 316)
        ...
        Me.cmdPokazZawartosc.Location = New System.Drawing.Point(456, 316)
...
#End Region
    ...
    Private Sub Katalogi_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.PictureBox2.Image = My.Resources.logomini
        'Me.TopMost = True
        Me.Icon = My.Resources.MrJones
        '-------------------------------
        Me.Text = oKomunikat
        lblPlik.Text = ParL_KatZbiorow & "|" & oPlik

        'inicjuje tabele
        lbxTabele.Items.Add("ANALIZYZAKUPU")
        lbxTabele.Items.Add("AKCJEOPIS")
        lbxTabele.Items.Add("AKCJESPEC")
        lbxTabele.Items.Add("KLIENCI")
        lbxTabele.Items.Add("KONTAKTYhandlowe")
        lbxTabele.Items.Add("OBROTY")
        lbxTabele.Items.Add("OBROTYMIES")
        lbxTabele.Items.Add("OSOBY")
        lbxTabele.Items.Add("PARAMETRY")
        lbxTabele.Items.Add("UZYTKOWNICY")
        lbxTabele.Items.Add("WERSJA")
        lbxTabele.Select()
    End Sub
    ...
    Private Sub lbxTabele_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbxTabele.Click
        ...
        Dim dbConnection As New OleDb.OleDbConnection(sConnection)
        Dim dbCommandSelect As New OleDb.OleDbCommand(sSelectSQL, dbConnection)
        Dim dbDataAdapter As New OleDb.OleDbDataAdapter(dbCommandSelect)
    ...
    Private Sub cmdPokazZawartosc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdPokazZawartosc.Click
        If Len(Trim(NazwaTabeli)) > 0 Then
            oTabela = NazwaTabeli
            Dim Form As New KatalogiZawartosc
            Form.ShowDialog()
        End If
    End Sub

    Private Sub Katalogi_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
        RysujGradient(Me)
    End Sub
End Class
