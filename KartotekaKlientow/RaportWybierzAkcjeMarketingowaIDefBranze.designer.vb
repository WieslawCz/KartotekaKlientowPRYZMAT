...
Partial Class RaportWybierzAkcjeMarketingowaIDefBranze
    'Inherits System.Windows.Forms.Form
    Inherits Softart.myDropShadowForm

    Dim _Ident As String
    Dim _dsKlienci As DataSet
    Dim _dvAkcjeSpec As DataView
    Dim _AktualizujKartKlientow As delegateAktualizuj
    Dim _Branza As String
    Dim _Podbranza As String

    Public Sub New(ByVal IdAkcji As String,
                   ByVal dsKlienci As DataSet,
                   ByVal dvAkcjeSpec As DataView,
                   ByVal Aktualizuj As delegateAktualizuj,
                   ByVal Branza As String,
                   ByVal Podbranza As String)
        MyBase.New()
        ...
        _Ident = IdAkcji
        _dsKlienci = dsKlienci
        _dvAkcjeSpec = dvAkcjeSpec
        _AktualizujKartKlientow = Aktualizuj
        _Branza = Branza
        _Podbranza = Podbranza
    End Sub
    ...
    Private Sub InitializeComponent()
        ...
        '
        '
        'RaportWybierzAkcjeMarketingowaIDefBranze
        '
        ...
        Me.Name = "RaportWybierzAkcjeMarketingowaIDefBranze"
