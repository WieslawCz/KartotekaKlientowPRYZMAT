...
Public Class frmDrukujRaportAktywnosci0
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmDrukujRaportAktywnosci0))
        ...
        Me.picLogo.Location = New System.Drawing.Point(8, 82)
        ...
        Me.cmdDrukuj.Location = New System.Drawing.Point(633, 83)
        Me.cmdDrukuj.Name = "cmdDrukuj"
        Me.cmdDrukuj.Size = New System.Drawing.Size(70, 23)
        ...
        Me.cmdStop.Location = New System.Drawing.Point(709, 83)
        ...
        Me.dtpDoDaty.Location = New System.Drawing.Point(170, 32)
    ...
    " . . . . "
        ...
        Me.dtpOdDaty.Location = New System.Drawing.Point(170, 10)
    ...
    " . . . . . . . . . . . . . . "
        ...
        Me.cmdZapiszExcel.Location = New System.Drawing.Point(557, 83)
        Me.cmdZapiszExcel.Name = "cmdZapiszExcel"
        Me.cmdZapiszExcel.Size = New System.Drawing.Size(70, 23)
        ...
        Me.cmdZapiszExcel.Visible = False
        '
        'frmDrukujRaportAktywnosci0
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(802, 111)
        ...
        Me.Name = "frmDrukujRaportAktywnosci0"
...
#End Region
    ...
    Private Sub frmDrukujRaportAktywnosci0_Paint(ByVal sender As Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
        RysujGradient(Me)
    End Sub
    ...
    Private Function PrzygotujDane(ByVal pDodajTotal As Boolean) As Boolean
        ...
        'zakladamy kolumny
        'Pracownik|NazwaP|OpisP|Data|Telefony|WizytyO|Pozostale|KlBezDr|Oferty|Testy|Czyszczenie|Dostawy|Skup|SumaKon|KlLPoten|KlLPonow|KlAPoten|KlAPonow|NowiKl
        ...
        TableRoboczy.Columns.Add("KlBezDr", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("Oferty", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("Testy", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("Czyszczenie", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("Dostawy", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("Skup", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("SumaKon", Type.GetType("System.Int32"))
        TableRoboczy.Columns.Add("KlLPoten", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("KlLPonow", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("KlAPoten", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
        TableRoboczy.Columns.Add("KlAPonow", Type.GetType("System.String"))
        TableRoboczy.Columns.Item("Pracownik").MaxLength = 50
                ...
                If RoboOK And UzytkownicyOK And DaneDoRaportuOK And KontaktyOK Then
                    ...
                    If DataViewUzytkownicy.Count > 0 Then
                        For iU = 0 To DataViewUzytkownicy.Count - 1
                            ...
                            pOpis = GetTxtDRVField(DataViewUzytkownicy.Item(iU), "OPIS")
                            ...
                            If IleRecPrac > 0 Then
                                ...
                                dr("KlBezdr") = 0       'SumKlBezDr
                                dr("Oferty") = 0       'SumOferty
                                dr("Testy") = 0       'SumTesty
                                dr("Czyszczenie") = 0       'SumCzyszczenie
                                dr("Dostawy") = 0       'SumDostawy
                                dr("Skup") = 0       'SumSkup
                        ...
                        If pDodajTotal Then
                            ...
                            dr("KlBezdr") = 0       'TotKlBezDr
                            dr("Oferty") = 0       'TotOferty
                            dr("Testy") = 0       'TotTesty
                            dr("Czyszczenie") = 0       'TotCzyszczenie
                            dr("Dostawy") = 0       'TotDostawy
                            dr("Skup") = 0       'TotSkup
    ...
    Private Sub MyDoc_ZestawienieTowarow(ByVal sender As Object, ByVal e As PrintPageEventArgs)
        ...
        Do While True
            ...
            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(6.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(1.5), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(6.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(3.0), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(6.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(4.5), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(6.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(6.0), CType(3 * MyFont.GetHeight(e.Graphics), Single))

            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(12.5), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(14.0), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(15.5), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(17.0), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(18.5), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(20.0), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(21.5), CType(5 * MyFont.GetHeight(e.Graphics), Single))

            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(21.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(1.5), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(21.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(3.0), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(21.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(4.5), CType(3 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x + cm2pts(21.5), y + CType(2 * MyFont.GetHeight(e.Graphics), Single), cm2pts(6.0), CType(3 * MyFont.GetHeight(e.Graphics), Single))

            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(27.5), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            e.Graphics.DrawRectangle(DrawingPen, x, y, cm2pts(29.0), CType(5 * MyFont.GetHeight(e.Graphics), Single))
            ...
            CentrTxt("Wizyty", x + cm2pts(6.5), y, cm2pts(4 * 1.5), MyFont, e)
            CentrTxt("", x + cm2pts(12.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(14.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(15.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(17.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(18.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(20.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Aktywny kontakt", x + cm2pts(21.5), y, cm2pts(4 * 1.5), MyFont, e)
            CentrTxt("", x + cm2pts(27.5), y, cm2pts(1.5), MyFont, e)
            ...
            CentrTxt("Telefony", x + cm2pts(6.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Opieka", x + cm2pts(8.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Pozosta³e", x + cm2pts(9.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Kl. bez", x + cm2pts(11.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Oferty", x + cm2pts(12.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Testy", x + cm2pts(14.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Czyszczenie", x + cm2pts(15.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Dostawy", x + cm2pts(17.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Skup", x + cm2pts(18.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Suma", x + cm2pts(20.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Kl. laser", x + cm2pts(21.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Kl. laser", x + cm2pts(23.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Kl. atram.", x + cm2pts(24.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Kl. atram.", x + cm2pts(26.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("Pierwszy", x + cm2pts(27.5), y, cm2pts(1.5), MyFont, e)
            y += MyFont.GetHeight(e.Graphics)

            CentrTxt("", x, y, cm2pts(3.5), MyFont, e)
            CentrTxt("", x + cm2pts(3.5), y, cm2pts(2.0), MyFont, e)
            CentrTxt("", x + cm2pts(5.5), y, cm2pts(1.0), MyFont, e)
            CentrTxt("", x + cm2pts(6.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(8.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(9.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("drukarki", x + cm2pts(11.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(12.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("wstawione", x + cm2pts(14.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("klienci", x + cm2pts(15.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(17.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("", x + cm2pts(18.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("kontaktów", x + cm2pts(20.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("potenc.", x + cm2pts(21.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("ponow.", x + cm2pts(23.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("potenc.", x + cm2pts(24.5), y, cm2pts(1.5), MyFont, e)
            CentrTxt("ponow.", x + cm2pts(26.0), y, cm2pts(1.5), MyFont, e)
            CentrTxt("kontakt", x + cm2pts(27.5), y, cm2pts(1.5), MyFont, e)
            ...
            If Doc.NextRowNumber < DataViewRoboczy.Count Then
                Do
                    ...
                    pKlBezDr = 0        'drv("KlBezdr")
                    pOferty = 0        'drv("Oferty")
                    pTesty = 0        'drv("Testy")
                    pCzyszczenie = 0        'drv("Czyszczenie")
                    pDostawy = 0        'drv("Dostawy")
                    pSkup = 0        'drv("Skup")
                    pRazemKon = drv("SumaKon")
                    pKlLPoten = 0       'drv("KlLPoten")
                    pKlLPonow = 0       'drv("KlLPonow")
                    pKlAPoten = 0       'drv("KlAPoten")
                    pKlAPonow = 0       'drv("KlAPonow")
                    pNowiKl = drv("NowiKl")
                    ...
                    End If
                    RightTxt(pTelefon.ToString("N0"), x + cm2pts(6.5), y, cm2pts(1.5), MyFont, e)
                    RightTxt(pWizytyO.ToString("N0"), x + cm2pts(8.0), y, cm2pts(1.5), MyFont, e)
                    RightTxt(pPozostale.ToString("N0"), x + cm2pts(9.5), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pKlBezDr.ToString("N0"), x + cm2pts(11.0), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pOferty.ToString("N0"), x + cm2pts(12.5), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pTesty.ToString("N0"), x + cm2pts(14.0), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pCzyszczenie.ToString("N0"), x + cm2pts(15.5), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pDostawy.ToString("N0"), x + cm2pts(17.0), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pSkup.ToString("N0"), x + cm2pts(18.5), y, cm2pts(1.5), MyFont, e)
                    RightTxt(pRazemKon.ToString("N0"), x + cm2pts(20.0), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pKlLPoten.ToString("N0"), x + cm2pts(21.5), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pKlLPonow.ToString("N0"), x + cm2pts(23.0), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pKlAPoten.ToString("N0"), x + cm2pts(24.5), y, cm2pts(1.5), MyFont, e)
                    'RightTxt(pKlAPonow.ToString("N0"), x + cm2pts(26.0), y, cm2pts(1.5), MyFont, e)
                    RightTxt(pNowiKl.ToString("N0"), x + cm2pts(27.5), y, cm2pts(1.5), MyFont, e)
                    y += LineHeight
            ...
            If (Doc.NextRowNumber < DataViewRoboczy.Count) Then
                ...
                e.Graphics.DrawRectangle(DrawingPen, xBase, yBase, cm2pts(12.5), y - yBase)
                e.Graphics.DrawRectangle(DrawingPen, xBase, yBase, cm2pts(20), y - yBase)
                e.Graphics.DrawRectangle(DrawingPen, xBase, yBase, cm2pts(29), y - yBase)
            ...
            Else
                ...
                RightTxt(TotTelefon.ToString("N0"), x + cm2pts(6.5), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotWizytyO.ToString("N0"), x + cm2pts(8.0), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotPozostale.ToString("N0"), x + cm2pts(9.5), y, cm2pts(1.5), MyFont, e)
                'RightTxt(TotKlBezDr.ToString("N0"), x + cm2pts(11.0), y, cm2pts(1.5), MyFont, e)
                'RightTxt(TotOferty.ToString("N0"), x + cm2pts(12.5), y, cm2pts(1.5), MyFont, e)
                'RightTxt(TotTesty.ToString("N0"), x + cm2pts(14.0), y, cm2pts(1.5), MyFont, e)
                'RightTxt(TotCzyszczenie.ToString("N0"), x + cm2pts(15.5), y, cm2pts(1.5), MyFont, e)
                'RightTxt(TotDostawy.ToString("N0"), x + cm2pts(17.0), y, cm2pts(1.5), MyFont, e)
                'RightTxt(TotSkup.ToString("N0"), x + cm2pts(18.5), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotRazemKon.ToString("N0"), x + cm2pts(20.0), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotKlLPoten.ToString("N0"), x + cm2pts(21.5), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotKlLPonow.ToString("N0"), x + cm2pts(23.0), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotKlAPoten.ToString("N0"), x + cm2pts(24.5), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotKlAPonow.ToString("N0"), x + cm2pts(26.0), y, cm2pts(1.5), MyFont, e)
                RightTxt(TotNowiKl.ToString("N0"), x + cm2pts(27.5), y, cm2pts(1.5), MyFont, e)
                y += LineHeight
    ...
    '        Dim FormatNaglowek1(20) As String
    ...
    '        FormatNaglowek1(5) = "Wizyty"
    '        FormatNaglowek1(6) = "Wizyty"
    '        FormatNaglowek1(7) = "Wizyty"
    '        FormatNaglowek1(8) = "Wizyty"
    '        FormatNaglowek1(9) = "Oferty"
    '        FormatNaglowek1(10) = "Testy"
    '        FormatNaglowek1(11) = "Czyszczenie"
    '        FormatNaglowek1(12) = "Dostawy"
    '        FormatNaglowek1(13) = "Skup"
    '        FormatNaglowek1(14) = "Suma"
    '        FormatNaglowek1(15) = "Klienci L"
    '        FormatNaglowek1(16) = "Klienci L"
    '        FormatNaglowek1(17) = "Klienci A"
    '        FormatNaglowek1(18) = "Klienci A"
    '        FormatNaglowek1(19) = "Nowi"

    '        Dim FormatNaglowek2(20) As String
    '        FormatNaglowek2(0) = ""
    '        FormatNaglowek2(1) = ""
    '        FormatNaglowek2(2) = ""
    '        FormatNaglowek2(3) = ""
    ...
    '        FormatNaglowek2(7) = "Pozosta³e"
    '        FormatNaglowek2(8) = "Kl. bez dr."
    '        FormatNaglowek2(9) = ""
    '        FormatNaglowek2(10) = "wstawione"
    '        FormatNaglowek2(11) = "klienci"
    '        FormatNaglowek2(12) = ""
    '        FormatNaglowek2(13) = ""
    '        FormatNaglowek2(14) = "kontaktów"
    '        FormatNaglowek2(15) = "potenc."
    '        FormatNaglowek2(16) = "ponow."
    '        FormatNaglowek2(17) = "potenc."
    '        FormatNaglowek2(18) = "ponow."
    '        FormatNaglowek2(19) = "klienci"
