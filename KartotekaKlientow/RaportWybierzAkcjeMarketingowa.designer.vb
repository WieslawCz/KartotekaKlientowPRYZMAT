...
Partial Class RaportWybierzAkcjeMarketingowa
    ...
    Dim _InicjujKartKlientow As Boolean

    Public Sub New(ByVal IdAkcji As String, _
                   ByVal dsKlienci As DataSet, _
                   ByVal dvAkcjeSpec As DataView, _
                   ByVal Aktualizuj As delegateAktualizuj, _
                   ByVal Inicjuj As Boolean)
        MyBase.New()
    ...
    Private Sub InitializeComponent()
        ...
        '
        '
        'RaportWybierzAkcjeMarketingowa
        '
        ...
        Me.Name = "RaportWybierzAkcjeMarketingowa"
